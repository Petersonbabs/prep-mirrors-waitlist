  ...
  return (
    ...
    >
      ...
      <div className="bg-neutral-50 rounded-lg p-4 border-2 border-neutral-200">
        <div className="aspect-[9/16] max-h-[500px] mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
          <iframe
      ...
      <div className="flex flex-col gap-3">
        <a
          ...
          className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-neutral-900 text-white font-semibold rounded-lg hover:bg-neutral-800 transition-colors"
        >
